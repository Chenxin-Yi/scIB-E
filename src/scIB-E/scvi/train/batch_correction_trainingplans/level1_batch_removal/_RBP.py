...
class RBP_TrainingPlan(TrainingPlan):
    """Training plan for VAEs with Reverse Backpropagation (RBP) loss to encourage latent space mixing.
    ...
    **loss_kwargs
    ...
    def reverse_back_propagation_loss(self, z, batch_index):
        ...
        rbp_loss = self.criterion_ce(cls_logits, torch.squeeze(batch_index))
        return rbp_loss
    ...
    def training_step(self, batch, batch_idx):
        ...
        rbp_loss = self.batch_correction_weight * self.reverse_back_propagation_loss(z, batch_label)
        loss += rbp_loss
        ...
        self.log("RBP_loss", rbp_loss, on_epoch=True, prog_bar=True)
