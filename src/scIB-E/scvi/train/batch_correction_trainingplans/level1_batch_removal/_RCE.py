...
class RCE_TrainingPlan(TrainingPlan):
    """Training plan for VAEs with Reverse Cross-Entropy (RCE) loss to encourage latent space mixing.
    ...
    **loss_kwargs
    ...
    def training_step(self, batch, batch_idx):
        ...
        rce_loss = self.batch_correction_weight * self.RCE_loss(z, batch_label)
        loss += rce_loss
