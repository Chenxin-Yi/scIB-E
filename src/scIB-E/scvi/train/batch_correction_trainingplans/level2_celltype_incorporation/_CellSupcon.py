...
class CellSupcon_TrainingPlan(TrainingPlan):
    """Training plan for VAEs with Cell Supervised contrastive learning (CellSupcon) loss to encourage latent space mixing.
    ...
    **loss_kwargs
    ...
    def __init__(
        ...
        **loss_kwargs,
        ...
        self.batch_correction_weight = batch_correction_weight["celltype_constraint_weight"]
    ...
    def training_step(self, batch, batch_idx):
        ...
        supcon_loss = self.batch_correction_weight * self.supervised_contrastive_loss(z, celltype_labels)
        loss += supcon_loss
