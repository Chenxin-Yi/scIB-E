...
class Orthog_CellSupcon_TrainingPlan(TrainingPlan):
    """Training plan for VAEs with Orthog loss and CellSupcon loss to encourage latent space mixing.
    ...
    **loss_kwargs
    ...
    def training_step(self, batch, batch_idx):
        ...
        orthog_loss = self.batch_constraint_weight * self.orthogonalization_loss(z, batch_embs)
        loss += orthog_loss
