...
class HSIC_CellSupcon_TrainingPlan(TrainingPlan):
    """Training plan for VAEs with HSIC loss and CellSupcon loss to encourage latent space mixing.
    ...
    **loss_kwargs
    ...
    def training_step(self, batch, batch_idx):
        ...
        hsic_loss = self.batch_constraint_weight * self.hsic(z, batch_embs)
        loss += hsic_loss
