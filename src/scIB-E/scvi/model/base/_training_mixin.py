...
from scvi.dataloaders import DataSplitter, DataSplitterWithIndex
    ...
    def train(
        ...
        **kwargs
        ...
        if data_module is None:
            ...
            if KFold_kwargs:
                self._data_splitter_cls = DataSplitterWithIndex
                data_module = self._data_splitter_cls(
                    self.adata_manager,
                    load_sparse_tensor=load_sparse_tensor,
                    **KFold_kwargs,  # Use KFold_kwargs for index-based splitting
                    **datasplitter_kwargs,  # Other common arguments
                )
            else:
                data_module = self._data_splitter_cls(
                    self.adata_manager,
