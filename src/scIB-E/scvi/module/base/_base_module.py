...
class LossOutput:
    ...
    # batch_removal_loss: LossRecord | None = None
    ...
    # batch_removal_loss_sum: Tensor = field(default=None)
    ...
    def __post_init__(self):
        ...
        # if self.batch_removal_loss is None:
        #     object.__setattr__(self, "batch_removal_loss", default)
        ...
        # object.__setattr__(self, "batch_removal_loss", self._as_dict("batch_removal_loss"))
        object.__setattr__(
            self,
        ...
        # object.__setattr__(self, "batch_removal_loss_sum", self.dict_sum(self.batch_removal_loss))
